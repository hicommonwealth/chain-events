...
export declare const EventChains: readonly ["clover", "edgeware", "edgeware-local", "edgeware-testnet", "hydradx", "kusama", "kusama-local", "polkadot", "polkadot-local", "kulupu", "stafi"];
