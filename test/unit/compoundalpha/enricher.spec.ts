...
import { EventKind, RawEvent, Api } from '../../../src/compoundalpha/types';
import { Enrich } from '../../../src/compoundalpha/filters/enricher';
...
describe('Compoundalpha Event Enricher Filter Tests', () => {
  // Uni Events
  // Approval
  ...
  // MinterChanged
  it('should enrich MinterChanged event', async () => {
    const kind = EventKind.MinterChanged;
    const minter = 'minter';
    const newMinter = 'newMinter';
    const event = constructEvent({
      minter,
      newMinter
    });
