...
import { Processor } from '../../../src/compoundalpha/processor';
import { Api, RawEvent, EventKind } from '../../../src/compoundalpha/types';
const { assert } = chai;
...
describe('Compoundalpha Event Processor Tests', () => {
