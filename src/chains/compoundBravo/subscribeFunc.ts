...
import { GovernorBravoDelegate__factory as GovernorBravoDelegateFactory } from '../../contractTypes';
...
export async function createApi(
  ...
  for (let i = 0; i < 3; ++i) {
    try {
      ...
      const governorAlphaContract = GovernorBravoDelegateFactory.connect(
